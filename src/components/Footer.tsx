  ...
  return <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-pegasus-orange">About Pegasus Tool</h3>
            ...
            <div className="flex space-x-3">
              <a href="#" className="text-gray-400 hover:text-pegasus-orange transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-pegasus-orange">Quick Links</h3>
            <ul className="space-y-2">
              <li><a href="#home" className="text-gray-400 hover:text-white transition-colors">Home</a></li>
              <li><a href="#supported-models" className="text-gray-400 hover:text-white transition-colors">Supported Models</a></li>
              <li><a href="#pricing" className="text-gray-400 hover:text-white transition-colors">Pricing</a></li>
              <li><a href="#resellers" className="text-gray-400 hover:text-white transition-colors">Resellers</a></li>
          ...
          {/* Support */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-pegasus-orange">Support</h3>
            <ul className="space-y-2">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-pegasus-orange">Contact Info</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-gray-500 flex items-center mt-4 md:mt-0">
            Made with <Heart className="h-4 w-4 mx-1 text-red-500" /> by Pegasus Team
          </p>
        </div>
      </div>
    </footer>;
