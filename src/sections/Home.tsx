  ...
  return (
    <div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <a href="#features">
              <Button 
                className="bg-pegasus-orange hover:bg-orange-600 text-white px-8 py-3 rounded-full text-lg"
              >
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="section-title text-pegasus-orange">Powerful Software Interface</h2>
          ...
          <div className="flex justify-center mt-12">
            <div className="flex flex-col md:flex-row items-center p-6 bg-white dark:bg-gray-800 rounded-full shadow-lg">
              ...
              <div className="text-center md:text-left mb-4 md:mb-0">
                <h3 className="text-xl font-semibold">Pegasus Tool v1.1.7</h3>
                <p className="text-gray-600 dark:text-gray-300">Latest version with enhanced features and bug fixes</p>
              </div>
              <Button 
                className="ml-0 md:ml-8 bg-pegasus-orange hover:bg-orange-600 text-white px-6 py-2 rounded-full"
              >
                Download Now
              </Button>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-400 text-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div>
              <Button 
                className="bg-white text-orange-600 hover:bg-orange-50 px-8 py-4 rounded-full text-lg shadow-lg"
              >
